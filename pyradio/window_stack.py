...
class Window_Stack_Constants(object):
    ...
    RADIO_BROWSER_CONFIG_FROM_CONFIG_MODE = 75
    MAIN_HELP_MODE = 100
    ...
    RADIO_BROWSER_CONFIG_HELP_MODE = 122
    ASK_TO_SAVE_BROWSER_CONFIG_FROM_BROWSER = 123
    ASK_TO_SAVE_BROWSER_CONFIG_FROM_CONFIG = 124
    ASK_TO_SAVE_BROWSER_CONFIG_TO_EXIT = 125
    WIN_MANAGE_PLAYERS_MSG_MODE = 126
    WIN_PRINT_EXE_LOCATION_MODE = 127
    ...
    MODE_NAMES = {
        ...
        RADIO_BROWSER_CONFIG_FROM_CONFIG_MODE: 'RADIO_BROWSER_CONFIG_FROM_CONFIG_MODE',
    ...
    FULL_SCREEN_MODES = (
        ...
        RADIO_BROWSER_CONFIG_FROM_CONFIG_MODE,
    )
