...
class Window_Stack_Constants():
    ...
    KEYBOARD_CONFIG_SEARCH_MODE = 19
    ...
    CHANGE_PLAYER_HELP_MODE = 124
    CONNECTION_HELP_MODE = 125
    REMOTE_CONTROL_SERVER_NOT_ACTIVE_HELP_MODE = 126
    FUZZY_STATION_SEARCH_MODE = 127
    ...
    MODE_NAMES = {
        ...
        LOCALIZED_GET_LANG_NAME: 'LOCALIZED_GET_LANG_NAME',
        ...
        FUZZY_STATION_SEARCH_MODE: 'FUZZY_STATION_SEARCH_MODE',
}
