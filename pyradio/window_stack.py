...
class Window_Stack_Constants(object):
    ...
    SERVER_START_ERROR_MODE = 318
    SERVER_DEAD_ERROR_MODE = 319
    THEME_MODE = 400
    ...
    MODE_NAMES = {
        ...
        SERVER_START_ERROR_MODE: 'SERVER_START_ERROR_MODE',
        SERVER_DEAD_ERROR_MODE: 'SERVER_DEAD_ERROR_MODE',
    }
    ...
    PASSIVE_WINDOWS = (
        ...
        SELECT_PLAYLIST_HELP_MODE,
        SERVER_START_ERROR_MODE,
        SERVER_DEAD_ERROR_MODE,
    )
